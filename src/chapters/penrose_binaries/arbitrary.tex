...
\end{equation}
%
Note that even though $V$, $P$ and $\gamma$ are spatial quantities, we attribute to them Greek indices. This is to be understood as a simple extension of these quantities where temporal components are identically zero for notational reasons.
...
From the coefficients of the quadratic, we can then explicitly write~\cite{Larson2006, Young2010, Lawrence2014}
%
\begin{equation}
