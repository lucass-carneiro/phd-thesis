\documentclass[12pt, twoside, american, brazil]{report}
...
\chapter{The Penrose process in binary spacetimes}
\label{ch:penrose_binaries}
\input{src/chapters/penrose_binaries.tex}

\myclearpage
\par

\chapter{Quasinormal modes in binary spacetimes}
\label{ch:qnm_binaries}
\input{src/chapters/qnm_binaries.tex}
